...
//   const template =
//     templates[card.template as keyof typeof templates] || templates.modern;
...
//             <div
//               className={`rounded-2xl shadow-xl overflow-hidden ${template.gradient}`}
//             >
//               <div className="p-8">
//                 {/* Header */}
...
//                     <div>
//                       <h1
//                         className={`text-2xl font-bold ${template.textColor}`}
//                       >
//                         {card.firstName} {card.lastName}
//                       </h1>
//                       {card.jobTitle && (
//                         <p
//                           className={`text-lg ${template.textColor} opacity-90`}
//                         >
//                           {card.jobTitle}
//                         </p>
//                       )}
//                       {card.company && (
//                         <p
//                           className={`text-sm ${template.textColor} opacity-75`}
//                         >
//                           {card.company}
//                         </p>
//                       )}
...
//                   </div>
//                   <div
//                     className={`w-12 h-12 ${template.accentColor} rounded-full flex items-center justify-center`}
//                   >
//                     <svg
...
//                   <div className="mb-6">
//                     <p
//                       className={`${template.textColor} opacity-90 leading-relaxed`}
//                     >
//                       {card.bio}
//                     </p>
//                   </div>
...
//                     <div className="flex items-center space-x-3">
//                       <div
//                         className={`w-8 h-8 ${template.accentColor} rounded-lg flex items-center justify-center`}
//                       >
//                         <svg
//                           className="w-4 h-4 text-white"
//                           fill="none"
...
//                       <div
//                         className={`text-xs ${template.textColor} opacity-75 mb-1`}
//                       >
//                         Nationality
//                       </div>
...
// Redesigned CardView to match the image reference
"use client";
