        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-gray-900">Create Digital ID Card</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {step === 1 && (
          <div className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">Choose Your Card Template</h2>
            <div className="grid md:grid-cols-3 gap-6">
              {templates.map((template) => (
                ...
                >
                  <div className={`w-full h-32 rounded-lg ${template.preview} mb-4`} />
        ...
        {step === 2 && (
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <form className="space-y-6">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mt-8 mb-4">Social Media</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div className={`rounded-xl p-6 text-white ${templates.find(t => t.id === selectedTemplate)?.preview}`}>
                  <div className="text-center">
                    ...
                    {formData.jobTitle && (
                      <p className="text-sm opacity-90 mb-2">{formData.jobTitle}</p>
                    )}
                    {formData.company && (
